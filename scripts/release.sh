...
echo "## [$NEW_V_VERSION](https://github.com/loudml/$REPO_NAME/tree/$NEW_V_VERSION) ($CURR_DATE)" >> $TMP_CHANGELOG_FILE
echo "[Full Changelog](https://github.com/loudml/$REPO_NAME/compare/$ORIG_V_VERSION...$NEW_V_VERSION)" >> $TMP_CHANGELOG_FILE
echo "" >> $TMP_CHANGELOG_FILE

echo "Updating README.md"
sed -i .old "s/loudml\/$ORIG_VERSION\/loudml.min.js/loudml\/$NEW_VERSION\/loudml.min.js/g" README.md
